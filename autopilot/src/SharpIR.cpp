...
int SharpIR::cm() {
    ...
    float voltFromRaw = raw * 0.0048828125;
    int puntualDistance;
    if (_model == 1080) {
        // puntualDistance = 27.728 * pow(voltFromRaw/1000, -1.2045);
        puntualDistance = 29.6 * pow(voltFromRaw, -1.2);
    } else if (_model == 20150) {
        // puntualDistance = 61.573 * pow(voltFromRaw/1000, -1.1068);
        puntualDistance = 65.0 * pow(voltFromRaw, -1.1);
    } else if (_model == 430) {
        puntualDistance = 13.0 * pow(voltFromRaw, -1.1);
    }
